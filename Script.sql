...
CREATE TABLE IF NOT EXISTS `SDEdb`.`product_location` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_product_location_Product_city_location1_idx` (`adress` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SDEdb`.`users` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_users_user_group_idx` (`user_group_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SDEdb`.`Product_rentals` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_product_booking_users1_idx` (`users_id` ASC) VISIBLE,
  INDEX `fk_product_booking_products1_idx` (`products_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SDEdb`.`Product_enhed` (
  ...
  INDEX `fk_Product_enhed_product_status1_idx` (`product_status_id` ASC) VISIBLE,
  INDEX `fk_Product_enhed_products1_idx` (`products_id` ASC) VISIBLE,
