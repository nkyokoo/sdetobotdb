...
CREATE TABLE IF NOT EXISTS `SDEdb`.`product_location` (
  ...
  INDEX `fk_product_location_Product_city_adresse1_idx` (`Product_city_adresse_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `SDEdb`.`products` (
  ...
  INDEX `fk_products_product_location1_idx` (`product_location_id` ASC) VISIBLE,
  INDEX `fk_products_leverandør1_idx` (`leverandør_id` ASC) VISIBLE,
