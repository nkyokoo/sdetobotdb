module.exports = {
    ...
    handler: async (request, h) => {
        try {
            ...
            const [request_count] = await pool.query('SELECT COUNT(*) as request_count, (SELECT COUNT(*) from wish_list WHERE end_date > NOW() AND godkendt = 1) as request_activeCount FROM wish_list WHERE godkendt = 0')
